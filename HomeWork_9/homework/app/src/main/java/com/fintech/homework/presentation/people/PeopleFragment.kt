...
import com.fintech.homework.presentation.profile.UserFragment
import com.fintech.homework.presentation.streams.StreamsViewModel
...
class PeopleFragment : Fragment(), OnPersonClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        initUi()
        if (savedInstanceState == null) viewModelPeople.searchPeople(StreamsViewModel.INITIAL_QUERY)
    }
